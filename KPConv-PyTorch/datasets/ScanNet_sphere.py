...
class ScanNetDataset(PointCloudDataset):
    ...
    def potential_item(self, batch_i, debug_workers=False):
        ...
        while True:
            ...
            # Stack batch
            # use fix num of points in sphere here not, because of augmentation
            p_list += [input_points]
            #--------------------------------
        ...
        input_list += [scales, rots, cloud_inds, point_inds, input_inds, knn_list]
    ...
    def load_subsampled_clouds(self):
        ...
        for index, data_i in enumerate(self.files):
            ...
            if exists(KDTree_file):
                ...
                sub_data = {'sub_points': sub_points, 'sub_labels' : sub_labels, 'rgbd_dict' : sub_rgbd_dict}
