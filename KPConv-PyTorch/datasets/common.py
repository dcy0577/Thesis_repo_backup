...
class PointCloudDataset(Dataset):
    ...
    def init_labels(self):
        ...
        self.label_names = ['unclassified','wall', 'floor', 'cabinet', 'bed', 'chair', 'sofa', 'table', 'door',
    ...
    #-----------------NEW 4.30.2021---------------------------------------
    def segmentation_inputs_new(self,
                            stacked_points,
                            stacked_image_xyz,
                            stacked_feature_2d,
                            stacked_feature_points,
                            labels,
                            stack_lengths):
        ...
        for block_i, block in enumerate(arch):
            ...
            # Updating input lists
            input_points += [stacked_points]
            #points for feat_aggre? as feature_list?
        ...
        # list of network inputs
        li = input_points + input_neighbors + input_pools + input_upsamples + input_stack_lengths
        li += [stacked_feature_points,stacked_image_xyz,stacked_feature_2d,labels]

        return li

 #-----------------NEW 5.7.2021---------------------------------------
    def segmentation_inputs_sphere(self,
                            stacked_points,
                            stacked_image_xyz,
                            stacked_images,
                            stacked_knn,
        ...
        # list of network inputs
        li = input_points + input_neighbors + input_pools + input_upsamples + input_stack_lengths
        li += [stacked_feature_points,stacked_image_xyz,stacked_images,stacked_knn, labels]
