...
# from datasets.ScanNet_sphere import ScanNetDataset
...
def experiment_name_1():
    ...
    start = 'Log_2021-07-07_20-23-38'
    end = 'Log_2021-07-07_20-23-38'
...
def experiment_name_2():
    ...
    # Using the dates of the logs, you can easily gather consecutive ones. All logs should be of the same dataset.
    start = 'Log_2021-05-02_08-37-09'
    end = 'Log_2021-05-02_08-37-09'
