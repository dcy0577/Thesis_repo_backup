...
def parse_args():
    ...
    parser.add_argument('--cache-dir', type=str, default='ScanNet/cache_rgbd', help='cache directory')
    parser.add_argument('--image-dir', type=str, default='ScanNet/scans_resize_160x120', help='image directory')
